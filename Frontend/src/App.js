  ...
  render() {
    ...
    return (
      <div className="container">
          ...
          <textarea name="abstract" id="abstractInput" className="col-8" rows="10" value={this.state.abst_input}
            onChange={(e) => { this.setState({ abst_input: e.target.value }) }}></textarea>
...
function NavBar() {
  return (
    <div className="navbar navbar-light bg-light">
      Abstractor- Topic Modeling Dashboard
    </div>
  )
}
